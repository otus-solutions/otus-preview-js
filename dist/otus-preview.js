...
(function() {
    ...
    function CoreTemplateLoaderService($compile, $templateRequest, $templateCache, UiTemplateContentFactory) {
        /*
         Json de exemplo:
        ...
        function buildItemTemplate(template) {
            if (template.itemContainer.length > 0) { // existem questões?
                ...
                for (var key in questions) {
                    UiTemplateContentFactory.create(scope, element, questions[key]);
                }
            }
        }
